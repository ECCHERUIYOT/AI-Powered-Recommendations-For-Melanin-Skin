...
page_selection = st.sidebar.radio("Do you want products based on:", ("Your Features/Interests?", "Product Highlights?", "A Product You Already Like?", "Hybrid Recommendations"))
...
if page_selection == "Your Features/Interests?":
    ...
    st.markdown('## Highlights Product Recommendation', unsafe_allow_html=True)
    ...
    if not recommended_products.empty:
        st.write("Here are some products that match your selection:")
